...
os.system(rf'sqlcmd -S {src_server} -E -i sql_server_scripts\101_create_db_and_schemas.sql')
os.system(rf'sqlcmd -S {src_server} -E -i sql_server_scripts\102_create_stg_utilities.sql')
os.system(rf'sqlcmd -S {src_server} -E -i sql_server_scripts\201_create_stg_tables.sql')
os.system(rf'sqlcmd -S {src_server} -E -i sql_server_scripts\301_create_views_stg_to_dwh.sql')
