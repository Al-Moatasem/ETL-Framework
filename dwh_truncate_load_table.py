...
def dwh_truncate_and_load(table_name, schema_source, schema_target, connection_info_source, connection_info_target, connection_info_etl):
    ...
    audit_key = insert_audit_record(cnxn_etl, -1, f'dwh loading {table_name}', '', table_name)
...
if __name__ == '__main__':
    ...
    for table_name in tables:
        dwh_truncate_and_load(table_name, 'stg', 'dwh', connection_info_stg, connection_info_target, connection_info_etl)