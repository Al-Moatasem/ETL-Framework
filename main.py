...
if __name__ == '__main__':
    ...
    if load_stg:
        etl_metadata_stg = etl_metadata[(etl_metadata['enabled'] == 1) & (etl_metadata['layer'] == 'staging')]
    ...
    if load_dwh:
        etl_metadata_dwh = etl_metadata[(etl_metadata['enabled'] == 1) & (etl_metadata['layer'] == 'data warehouse')]
